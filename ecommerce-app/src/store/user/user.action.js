...
export const emailSignInStart = (email,password)=>{
    return {type:USER_ACTION_TYPES.EMAIL_SIGN_IN_START,payload:{
        email,
        password
    }}
}
...
return{type:USER_ACTION_TYPES.SIGN_UP_SUCCESS,payload:{user,addtionalDetails}}
}

export const  signUpFailed = (error)=>{
    return{type:USER_ACTION_TYPES.SIGN_UP_SUCCESS,payload:error}
    }
...
return{type:USER_ACTION_TYPES.SIGN_OUT_START}
    ...
    export const  signOutSuccess = ()=>{
        ...
        export const  signOutFailed = (error)=>{
            return{type:USER_ACTION_TYPES.SIGN_OUT_SUCCESS,payload:error}
            }